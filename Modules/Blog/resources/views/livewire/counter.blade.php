        ...
        <div
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="text-start text-lg font-semibold text-white flex flex-col gap-5">
                    <p><strong>Module:</strong> Modules/Blog</p>
                    <p><strong>CLASS:</strong> Modules/Blog/Livewire/Counter.php</p>
                    <p><strong>VIEW:</strong> Modules/Blog/Resources/views/livewire/counter.blade.php</p>
                    <p><strong>TAG:</strong> &lt;livewire:blog::counter/&gt;</p>
                </div>
            </div>
        </div>
    </div>
