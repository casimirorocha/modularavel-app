		...
		<div
			...
			<div class="flex flex-col gap-5">
				...
				<div class="text-start text-lg font-semibold text-white flex flex-col gap-5">
					<p><strong>Module:</strong> Modules/Groups</p>
					<p><strong>CLASS:</strong> Modules/Groups/Livewire/Counter.php</p>
					<p><strong>VIEW:</strong> Modules/Groups/Resources/views/livewire/counter.blade.php</p>
					<p><strong>TAG:</strong> &lt;livewire:groups::counter/&gt;</p>
				</div>
			</div>
		</div>
	</div>
