        ...
        <div
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="text-start text-lg font-semibold text-white flex flex-col gap-5">
                    <p><strong>Module:</strong> Modules/Like</p>
                    <p><strong>CLASS:</strong> Modules/Like/Livewire/Counter.php</p>
                    <p><strong>VIEW:</strong> Modules/Like/Resources/views/livewire/counter.blade.php</p>
                    <p><strong>TAG:</strong> &lt;livewire:like::counter/&gt;</p>
                </div>
            </div>
        </div>
    </div>
