		...
		<div
			...
			<div class="flex flex-col gap-5">
				...
				<div class="text-start text-lg font-semibold text-white flex flex-col gap-5">
					<p><strong>Module:</strong> Modules/Modularavel</p>
					<p><strong>CLASS:</strong> Modules/Modularavel/Livewire/Counter.php</p>
					<p><strong>VIEW:</strong> Modules/Modularavel/Resources/views/livewire/counter.blade.php</p>
					<p><strong>TAG:</strong> &lt;livewire:modularavel::counter/&gt;</p>
				</div>
			</div>
		</div>
	</div>
