        ...
        <div class="transition-colors bg-gray-800 px-6 py-8 shadow-2xl text-center rounded-2xl border-2 border-gray-500 m-5">
            <div class="flex flex-col gap-5">
                ...
                <div class="text-start text-xs md:text-[1rem] font-semibold text-white flex flex-col gap-5 mx-11/12">
                    ...
                    <p><strong>VIEW:</strong> Modules/Auth/Resources/views/livewire/privacy.blade.php</p>
                    <p><strong>TAG:</strong> {{ $tag }}</p>
                </div>
                <div>
                    <p class="text-lg text-gray-500">The <code>Privacy</code> livewire component is loaded from the <code>Auth</code> module.</p>
                </div>
            </div>
        </div>
    </div>
