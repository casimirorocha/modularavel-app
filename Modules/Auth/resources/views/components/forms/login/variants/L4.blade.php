            ...
            <div class="w-full p-6">
                <form>
                    <div class="mb-8">
                        ...
                        <p class="text-sm mt-4 text-gray-800 dark:text-white">Don't have an account <a href="javascript:void(0);" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
                    </div>

                    <div>
                        <label class="text-gray-800 dark:text-white text-[15px] mb-2 block">Email</label>
                        <div class="relative flex items-center">
                            <input name="email" type="text" required class="w-full text-sm text-gray-800 dark:text-white bg-gray-100 focus:bg-transparent px-4 py-3.5 rounded-md outline-blue-600" placeholder="Enter email" />
                    ...
                    <div class="mt-4">
                        <label class="text-gray-800 dark:text-white text-[15px] mb-2 block">Password</label>
                        <div class="relative flex items-center">
                            <input name="password" type="password" required class="w-full text-sm text-gray-800 dark:text-white bg-gray-100 focus:bg-transparent px-4 py-3.5 rounded-md outline-blue-600" placeholder="Enter password" />
                    ...
                    <div class="mt-8">
                        <button type="button" class="w-full py-3 px-6 text-sm tracking-wide rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                            Sign in
                        </button>
                    </div>

                    <div class="my-4 flex items-center gap-4">
                        <hr class="w-full border-gray-300 dark:border-gray-500" />
                        <p class="text-sm text-gray-800 dark:text-gray-500 text-center">or</p>
                        <hr class="w-full border-gray-300 dark:border-gray-500" />
                    </div>
