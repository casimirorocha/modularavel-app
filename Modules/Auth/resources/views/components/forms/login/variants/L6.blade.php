<div class="font-[sans-serif]">
    <div class="grid lg:grid-cols-2 md:grid-cols-2 items-center gap-4">
        ...
        <form class="max-w-xl w-full p-6 mx-auto">
            <div class="mb-12">
                <h3 class="text-gray-800 text-4xl font-extrabold">{{ $options?->pages['login']['title'] ?? __('Sign in') }}</h3>
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    <input name="email" type="text" required class="w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
            ...
            <div class="mt-8">
                ...
                <div class="relative flex items-center">
                    <input name="password" type="password" required class="w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" />
            ...
            <button type="button" class="w-full flex items-center justify-center gap-4 py-2.5 px-4 text-sm tracking-wide text-gray-800 border border-gray-300 rounded-md bg-transparent hover:bg-gray-50 focus:outline-none">
